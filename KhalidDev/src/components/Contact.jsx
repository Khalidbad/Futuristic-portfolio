...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: '📧',
      title: 'Email',
      value: 'khalidbaddou479@gmail.com',
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Khalidbad',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/baddou-khalid-9a164429b/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gradient-to-br from-space-black to-dark-navy border border-electric-blue/20 rounded-2xl p-8 hover:border-electric-blue/40 transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-left text-soft-white font-medium mb-2">Name</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-left text-soft-white font-medium mb-2">Email</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div>
                <label className="block text-left text-soft-white font-medium mb-2">Subject</label>
                <input
                  type="text"
                  name="subject"
              ...
              <div>
                <label className="block text-left text-soft-white font-medium mb-2">Message</label>
                <textarea
                  name="message"
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-futuristic font-semibold text-electric-blue group-hover:text-glow transition-all duration-300 text-left">
                        {info.title}
                      </h4>
                      <p className="text-soft-white/80 text-left">{info.value}</p>
                    </div>
                  </a>
                ))}
              </div>
